...
<div class="order-right">
    ...
    <div class="orders">
        <table class="order-item" v-for="order in myOrder.records" :key="order.id">
            ...
            <tbody>
            <tr v-for="item in order.orderDetailList" :key="item.id">
                <td width="60%">
                ...
                <td :rowspan="order.orderDetailList.length" 
                    width="8%" class="center">{{order.consignee}}</td>
                <td :rowspan="order.orderDetailList.length" 
                    width="13%" class="center">
                    <ul class="unstyled">
...
export default {
    ...
    methods: {
        async getOrderList(){
            ...
            // console.log(res);
            if(res.code == 200){
                console.log('center.vue', res.data);
