...
<script>
    ...
    beforeMount(){
        this.searchParams.category1Id = this.$route.query.categoryId1;
        this.searchParams.category2Id = this.$route.query.categoryId2;
        this.searchParams.category3Id = this.$route.query.categoryId3;
