<template>
  <div class="trade-container">
    ...
    <div class="trade">
      <div class="price">应付金额:xxx<span>¥5399.00</span></div>
    ...
    methods: {
      changeDefault(address, addressInfo){
        addressInfo.forEach(address => {
          return address.isDefault = 0;
        })
        address.isDefault = 1;
      },
      async submitOrder(){
        let res = await this.$API.reqSubmitOrder(this.orderInfo.tradeNo, {
          consignee: this.userDefaultAddress.consignee,
          consigneeTel: this.userDefaultAddress.phoneNum,
          deliveryAddress: this.userDefaultAddress.address,
          paymentWay: 'ONLINE',
